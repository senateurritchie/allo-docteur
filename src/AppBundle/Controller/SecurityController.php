...
use AppBundle\Form\DoctorRegistrationType;
use AppBundle\Form\ClinicRegistrationType;
...
class SecurityController extends Controller{
    ...
    */
    ...
    /**
    * @Route("/registration/{type}", name="registration", requirements={"type":"doctor|clinic"})
    */
    public function registrationAction(Request $request,$type){
        ...
        $user = $type == "doctor" ? new Doctor() : new Clinic();

        $form = $this->createForm($type == "doctor" ? DoctorRegistrationType::class : ClinicRegistrationType::class,$user,[
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            if($type == "doctor"){
                $user->getUser()->setUserType($r->findOneBySlug("doctor"));
            }
            else{
                $user->getUser()->setUserType($r->findOneBySlug("hospital"));
            }
            ...
            return $this->redirectToRoute("security_registration",["type"=>$type]);
        }
